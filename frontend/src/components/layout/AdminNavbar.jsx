    ...
    switch (currentUser?.role) {
        case 'admin':
            return {
                ...
                items: [
                    { path: '/admin/dashboard', label: 'Dashboard', type: 'dashboard' },
                    { path: '/admin/doctors', label: 'Doctors Management', type: 'users' },
                    { path: '/admin/labs', label: 'Labs Management', type: 'building' },
                    { path: '/admin/owners', label: 'Owner Management', type: 'crown' }, // ✅ ADD THIS
                    { path: '/reports/tat', label: 'TAT Reports', type: 'chart' },
                ],
                quickActions: [
                    { path: '/admin/new-doctor', label: 'Add Doctor', type: 'userPlus' },
                    { path: '/admin/new-lab', label: 'Add Lab', type: 'buildingPlus' },
                    { path: '/admin/owners', label: 'Create Owner', type: 'crown' }, // ✅ ADD THIS
                ]
            };
        case 'owner':
            return {
                ...
                items: [
                    { path: '/owner/dashboard', label: 'Dashboard', type: 'dashboard' },
                    { path: '/owner/invoices', label: 'Invoice Management', type: 'receipt' },
                ],
                quickActions: []
            };
        case 'doctor_account':
